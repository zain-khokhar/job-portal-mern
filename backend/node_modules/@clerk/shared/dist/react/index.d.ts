...
declare const useSubscription: (params?: UseSubscriptionParams) => {
    data: _clerk_types.CommerceSubscriptionResource | null | undefined;
    error: any;
    isLoading: boolean;
    isFetching: boolean;
    revalidate: () => Promise<_clerk_types.CommerceSubscriptionResource | null | undefined>;
};
